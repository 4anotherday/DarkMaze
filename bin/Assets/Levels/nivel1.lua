...
-- Bush
go_13 = {}
go_13[0] = { Name = "Bush1", HowManyCmps = 4, Persist = false}
go_13[1] = { Component = "Transform", Coord = {X = -10, Y = 2, Z = -10}, Rotation = {X = 0, Y = 0, Z = 0}, Scale = {X = 0.06, Y = 0.1, Z = 0.06}}
go_13[2] = {	Component = "RenderObject", MeshName="cube.mesh", Material="Practica1/Bush", 
						RotateAngle = 0, Rotate={X=0, Y=0, Z=0}, Scale = {X=1, Y=1, Z=1}, LookAt ={X=0, Y=0, Z=0},
						Visible=true, Shadows=false, RenderingDistance = 1000}
go_13[3] = { Component = "SphereCollider", Radius=3,IsTrigger=true}
go_13[4] = { Component = "HideoutComponent" ,Alpha=.7}
