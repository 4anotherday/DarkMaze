...
go_107[2] = { Component = "AudioSource", Route = {"Assets/Audio/goat_cry.mp3", "Assets/Audio/goat_cry.mp3"}, Stereo = true,
			MinMaxDistance = {Min = 2, Max = 6}, Volume= 0.5, Play = true}
...
go_108[4] = { Component = "AudioSource", Route = {"Assets/Audio/kamikaze_scream.wav" ,"Assets/Audio/kamikaze_explosion.mp3"}, Stereo = true,
