...
go_1 = {}
go_1[0] = { Name = "GameManager", HowManyCmps = 3, Persist = true}
go_1[1] = { Component = "Transform"}
go_1[2] = { Component = "GameManagerComponent"}
go_1[3] = { Component = "AudioSource", Route = {"Assets/Audio/ProtoDarkMaze_Menu.mp3","Assets/Audio/lose.wav","Assets/Audio/win.wav"}, 
...
go_2[2] = { Component = "ButtonComponent", Active = true, OverLayName="MenuUI", ContainerName= "Menu/QuitButton", 
			DefaultMaterial = "DefaultButton", HoverMaterial = "OverButton", PressMaterial = "ClickedButton"}
go_2[3] = { Component = "QuitButtonComponent"}

go_3 = {}
go_3[0] = { Name = "PlayButton", HowManyCmps = 3, Persist = false}
go_3[1] = { Component = "Transform"}
go_3[2] = { Component = "ButtonComponent", Active = true, OverLayName="MenuUI", ContainerName= "Menu/PlayButton", 
			DefaultMaterial = "DefaultButton", HoverMaterial = "OverButton", PressMaterial = "ClickedButton"}
go_3[3] = { Component = "PlayButtonComponent"}
